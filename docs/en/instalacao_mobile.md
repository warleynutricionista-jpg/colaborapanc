# Instalação do mobile (Expo) (EN)

> This is the English companion document for `docs/pt/instalacao_mobile.md`.
>
...
- Portuguese canonical version: [`docs/pt/instalacao_mobile.md`](../pt/instalacao_mobile.md)
