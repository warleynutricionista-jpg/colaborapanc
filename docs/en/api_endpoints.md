# Endpoints da API (estado real) (EN)

> This is the English companion document for `docs/pt/api_endpoints.md`.
>
...
- Portuguese canonical version: [`docs/pt/api_endpoints.md`](../pt/api_endpoints.md)
