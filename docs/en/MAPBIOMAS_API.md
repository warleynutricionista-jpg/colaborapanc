# Integração MapBiomas Alerta API (EN)

> This is the English companion document for `docs/pt/MAPBIOMAS_API.md`.
>
...
- Portuguese canonical version: [`docs/pt/MAPBIOMAS_API.md`](../pt/MAPBIOMAS_API.md)
