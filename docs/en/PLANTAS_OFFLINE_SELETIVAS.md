# Sistema de Plantas Offline Seletivas (EN)

> This is the English companion document for `docs/pt/PLANTAS_OFFLINE_SELETIVAS.md`.
>
...
- Portuguese canonical version: [`docs/pt/PLANTAS_OFFLINE_SELETIVAS.md`](../pt/PLANTAS_OFFLINE_SELETIVAS.md)
