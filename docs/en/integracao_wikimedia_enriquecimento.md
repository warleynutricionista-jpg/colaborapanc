# Integração Wikimedia/Wikipedia no enriquecimento controlado (EN)

> This is the English companion document for `docs/pt/integracao_wikimedia_enriquecimento.md`.
>
...
- Portuguese canonical version: [`docs/pt/integracao_wikimedia_enriquecimento.md`](../pt/integracao_wikimedia_enriquecimento.md)
