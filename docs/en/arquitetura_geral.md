# Arquitetura geral do ColaboraPANC (EN)

> This is the English companion document for `docs/pt/arquitetura_geral.md`.
>
...
- Portuguese canonical version: [`docs/pt/arquitetura_geral.md`](../pt/arquitetura_geral.md)
